...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cwwbhn1p1fhp.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesonurblog' # please enter your s3 bucket name
